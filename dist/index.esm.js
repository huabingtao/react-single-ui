...
var Icon = function Icon(props) {
  ...
  var classes = classNames('single-icon', className);
...
var Loading = function Loading(props) {
  ...
  var classes = classNames('single-loading', className);
...
var Modal = function Modal(props) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(ModalNode, _objectSpread2({}, restProps)),
  );
};
...
function Alert(props) {
  ...
  if (footer) {
    var cloneFooter = _.cloneDeep(footer);
...
var Progress = function Progress(props) {
  ...
  var percentCls = classNames(''.concat(ProgressPrefixCls, '-bar'));
...
var Breadcrmb = function Breadcrmb(props) {
  ...
  var classes = classNames(BreadcrmbPrefixCls);
...
var TabBarItem = function TabBarItem(props) {
  ...
  var context = useContext(BreadcrmbContext);
...
var TreeSelectSidebar = function TreeSelectSidebar() {
  var context = useContext(TreeSelectContext);
  var data = context.data,
    index = context.index,
    onChangeTree = context.onChangeTree,
    activeColor = context.activeColor;

  var _useState = useState(index || 0),
    _useState2 = _slicedToArray(_useState, 2),
...
var TreeSelectContent = function TreeSelectContent(props) {
  ...
  var handleChangeTreeItem = function handleChangeTreeItem(item, index) {
    ...
    if (
      ...
      var childActiveIdClone = _.cloneDeep(childActiveId);
      ...
      if (multiple) {
        var _childActiveIdClone = _.cloneDeep(childActiveId);
  ...
  var renderChildren = function renderChildren() {
    return selfData.map(function (item, index) {
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement('span', null, renderIcon(item)),
      );
    });
  };
...
var TreeSelectContext = /*#__PURE__*/ createContext({
  multiple: false,
  data: [],
});
...
var TreeSelect = function TreeSelect(props) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(TreeSelectSidebar, null),
      /*#__PURE__*/ React.createElement(TreeSelectContent, null),
    ),
  );
};
...
var Badge = function Badge(props) {
  ...
  var dotWrapCls = classNames(''.concat(BadgePrefixCls, '-wrap'));
